  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved vehicle as @vehicle" do
        ...
        post :create, {:vehicle => { "make" => "invalid value" }}, valid_session
        assigns(:vehicle).should be_a_new(Vehicle)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested vehicle" do
        ...
        Vehicle.any_instance.should_receive(:update_attributes).with({ "make" => "MyString" })
        put :update, {:id => vehicle.to_param, :vehicle => { "make" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the vehicle as @vehicle" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Vehicle.any_instance.stub(:save).and_return(false)
        put :update, {:id => vehicle.to_param, :vehicle => { "make" => "invalid value" }}, valid_session
        assigns(:vehicle).should eq(vehicle)
      end
